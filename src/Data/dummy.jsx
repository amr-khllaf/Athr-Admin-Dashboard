...
export const gridOrderCampaign = (props) => (
  <div>
    <img
      className="rounded-xl h-20 md:ml-3"
      src={props.ProductCampaign}
      alt="order-item"
    />
  </div>
);
...
const customerGridCampaign = (props) => (
  <div className="Campaign flex gap-4">
    <img
      className="rounded-full w-10 h-10"
      src={props.CustomerCampaign}
      alt="employee"
    />
    <div>
...
export const usersData = [
  {
    ...
    CampaignName: "Nirav Joshi",
    UserEmail: "nirav@gmail.com",
    CustomerCampaign: avatar2,
    CampaignName: "Hosting Press HTML",
    Status: "Active",
    StatusBg: "#8BE78B",
    Weeks: "40",
    Budget: "$2.4k",
  ...
  },
  {
    ...
    CampaignName: "Sunil Joshi",
    UserEmail: "sunil@gmail.com",
    CampaignName: "Elite Admin",
    Status: "Active",
    CustomerCampaign: avatar3,
  ...
  },
  {
    ...
    CampaignName: "Andrew McDownland",
    UserEmail: "andrew@gmail.com",
    CampaignName: "Real Homes WP Theme",
    Status: "Pending",
    CustomerCampaign: avatar4,
    StatusBg: "#FEC90F",
    Weeks: "19",
    Budget: "$24.5k",
    Category: "USA",
  },
  {
    ...
    CampaignName: "Christopher Jamil",
    UserEmail: "jamil@gmail.com",
    CampaignName: "MedicalPro WP Theme",
    Status: "Completed",
    CustomerCampaign: avatar,
    StatusBg: "#8BE78B",
    Weeks: "34",
    Budget: "$16.5k",
    Category: "USA",
  ...
  //   CampaignName: "Michael",
  //   UserEmail: "michael@gmail.com",
  //   CampaignName: "Weekly WP Theme",
  //   Status: "Cancel",
  //   CustomerCampaign: avatar2,
  //   StatusBg: "red",
  //   Weeks: "34",
...
export const CampaignsData = [
  {
    ...
    UserId: 1,
    TotalTarget: 32.38,
    Campaigns: "Fresh Tomato",
    Category: "USA",
    Status: "pending",
    StatusBg: "#FB9678",
    ProductCampaign: product6,
  },
  {
    CampaignId: 345653,
    CampaignName: "Carson Darrin",
    TotalTarget: 56.34,
    Campaigns: "Butter Scotch",
    Category: "Delhi",
    Status: "complete",
    StatusBg: "#8BE78B",
    ProductCampaign: product5,
  },
  {
    CampaignId: 390457,
    CampaignName: "Fran Perez",
    TotalTarget: 93.31,
    Campaigns: "Candy Gucci",
    Category: "New York",
    Status: "active",
    StatusBg: "#03C9D7",
    ProductCampaign: product7,
  },
  {
    CampaignId: 893486,
    CampaignName: "Anika Viseer",
    TotalTarget: 93.31,
    Campaigns: "Night Lamp",
    Category: "Germany",
    Status: "canceled",
    StatusBg: "#FF5C8E",
    ProductCampaign: product4,
  },
  {
    CampaignId: 748975,
    CampaignName: "Miron Vitold",
    TotalTarget: 23.99,
    Campaigns: "Healthcare Erbology",
    Category: "Spain",
    Status: "rejected",
    StatusBg: "red",
    ProductCampaign: product1,
  },
  {
    CampaignId: 94757,
    CampaignName: "Omar Darobe",
    TotalTarget: 95.99,
    Campaigns: "Makeup Lancome Rouge",
    Category: "USA",
    Status: "canceled",
    StatusBg: "#FF5C8E",
    ProductCampaign: product2,
  },
  {
    CampaignId: 944895,
    CampaignName: "Lulia albu",
    TotalTarget: 17.99,
    Campaigns: "Skincare",
    Category: "USA",
    Status: "active",
    StatusBg: "#03C9D7",
    ProductCampaign: product3,
  },
  {
    CampaignId: 845954,
    CampaignName: "Penjani",
    TotalTarget: 59.99,
    Campaigns: "Headphone",
    Category: "USA",
    Status: "complete",
  ...
  },
  {
    ...
    StatusBg: "#FB9678",
    ProductCampaign:
      "https://cdn.shopclues.com/Campaigns1/thumbnails/104158/320/320/148648730-104158193-1592481791.jpg",
  },
  {
    CampaignId: 874534,
    CampaignName: "Danai",
    ...
    StatusBg: "#FF5C8E",
    ProductCampaign:
      "https://hips.hearstapps.com/hmg-prod.s3.amazonaws.com/Campaigns/pop-womens-garmin-watches-1641919013.jpg?crop=0.502xw:1.00xh;0.250xw,0&resize=640:*",
  },
  {
    CampaignId: 38489,
    CampaignName: "Miron",
    ...
    StatusBg: "#03C9D7",
    ProductCampaign:
      "https://Campaigns.immediate.co.uk/production/volatile/sites/30/2020/08/dairy-free-ice-cream-eae372d.jpg",
  },
  {
    CampaignId: 24546,
    CampaignName: "Frank",
    ...
    StatusBg: "#8BE78B",
    ProductCampaign:
      "https://Campaigns.unsplash.com/photo-1576618148400-f54bed99fcfd?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1480&q=80",
  },
  {
    CampaignId: 874534,
    CampaignName: "Danai",
